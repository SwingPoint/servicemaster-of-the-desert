    ...
    <>
      ...
      <article className="mx-auto max-w-4xl px-4 py-12 lg:px-6 lg:py-16">
        ...
        <section aria-labelledby="residential-faq">
          <h2 id="residential-faq" className="mb-6 text-2xl font-bold text-slate-900">
        ...
        <section aria-labelledby="commercial-faq" className="mt-12">
          <h2 id="commercial-faq" className="mb-6 text-2xl font-bold text-slate-900">
        ...
        <section className="mt-12 rounded-xl bg-brand-blue p-8 text-center text-white">
          ...
          <a
            href={PHONE_LINK}
            className="mt-4 inline-block rounded-full bg-brand-orange px-6 py-3 font-semibold hover:bg-brand-orange-dark"
          >
            Call (442) 227-3064
          </a>
        </section>
